...
try:
    from plugins._notifications.tools.notify_user import NotifyUserTool
...
class TestNotifyUserToolExecute:
    ...
    async def test_valid_notification_succeeds(self, tool):
        with patch("plugins._notifications.tools.notify_user.AgentContext.get_notification_manager") as mock_mgr:
