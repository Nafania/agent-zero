...
from plugins._memory.helpers.vector_db import (
    VectorDB,
    format_docs_plain,
    get_comparator,
)
...
class TestVectorDB:
    ...
    async def test_insert_documents_adds_to_docs(self, mock_agent):
        ...
        with patch("plugins._memory.helpers.vector_db.configure_cognee"):
            with patch("plugins._memory.helpers.memory._get_cognee") as m:
                cognee = MagicMock()
