...
class TestGetConfig:
    def test_uses_get_cognee_setting(self, worker):
        with patch("plugins._memory.helpers.cognee_background.get_cognee_setting") as mock_setting:
...
class TestRunPipeline:
    ...
    async def test_cognify_with_temporal(self, worker):
        ...
        with patch.dict("sys.modules", {"cognee": mock_cognee}), \
             patch("plugins._memory.helpers.cognee_background.get_cognee_setting") as mock_setting:
            mock_setting.side_effect = lambda name, default: {
