...
class TestExtractJsonObjectString:
    ...
    def test_simple_object(self):
        from helpers.extract_tools import extract_json_object_string
...
class TestExtractJsonString:
    ...
    def test_extracts_object(self):
        from helpers.extract_tools import extract_json_string
...
class TestFixJsonString:
    ...
    def test_replaces_unescaped_newlines_in_string_values(self):
        from helpers.extract_tools import fix_json_string
...
class TestJsonParseDirty:
    ...
    def test_malformed_returns_none(self):
        ...
        with patch("helpers.extract_tools.DirtyJson") as mock_dirty:
