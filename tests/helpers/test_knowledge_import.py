...
class TestCalculateChecksum:
    def test_same_content_same_checksum(self, tmp_path):
        from plugins._memory.helpers.knowledge_import import calculate_checksum
        f = tmp_path / "a.txt"
...
class TestLoadKnowledge:
    def test_empty_knowledge_dir_returns_index(self):
        from plugins._memory.helpers.knowledge_import import load_knowledge
        with patch("plugins._memory.helpers.knowledge_import.PrintStyle"):
    ...
    def test_directory_not_readable_returns_index(self, tmp_path):
        ...
        kn_dir.mkdir()
        with patch("plugins._memory.helpers.knowledge_import.PrintStyle"):
            with patch("plugins._memory.helpers.knowledge_import.os.access", return_value=False):
