...
import plugins._notifications.helpers.notification as _notification_mod


@pytest.fixture(autouse=True)
def patch_mark_dirty():
    """Mock state_monitor_integration to avoid side effects."""
    with patch("helpers.state_monitor_integration.mark_dirty_all"):
        yield
...
class TestNotificationEnums:
    def test_notification_type_values(self):
        from plugins._notifications.helpers.notification import NotificationType
    ...
    def test_notification_priority_values(self):
        from plugins._notifications.helpers.notification import NotificationPriority
...
class TestNotificationItem:
    def test_notification_item_auto_generates_id(self):
        from plugins._notifications.helpers.notification import NotificationItem, NotificationManager, NotificationType, NotificationPriority
    ...
    def test_notification_item_coerces_type_from_str(self):
        from plugins._notifications.helpers.notification import NotificationItem, NotificationManager, NotificationPriority
...
class TestNotificationManager:
    def test_add_notification(self):
        from plugins._notifications.helpers.notification import NotificationManager, NotificationType, NotificationPriority
