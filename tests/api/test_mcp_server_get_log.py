"""Tests for api/mcp_server_get_log.py — McpServerGetLog API handler."""
...
from api.mcp_server_get_log import McpServerGetLog
...
class TestMcpServerGetLog:
    ...
    async def test_process_returns_log_on_success(self, mock_app):
        ...
        with patch("api.mcp_server_get_log.MCPConfig") as MockMCP:
