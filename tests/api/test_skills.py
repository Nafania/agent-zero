...
class TestCheckUpdates:
    @pytest.mark.asyncio
    @patch("plugins._skills.api.skills.skills_cli")
...
class TestMoveSkill:
    @pytest.mark.asyncio
    @patch("plugins._skills.api.skills.os.path.exists", return_value=False)
    @patch("plugins._skills.api.skills.os.makedirs")
    @patch("plugins._skills.api.skills.shutil.move")
    @patch("plugins._skills.api.skills.os.path.isdir", return_value=True)
    @patch("plugins._skills.api.skills.projects")
    ...
    @pytest.mark.asyncio
    @patch("plugins._skills.api.skills.os.path.isdir", return_value=False)
    ...
    @pytest.mark.asyncio
    @patch("plugins._skills.api.skills.os.path.exists", return_value=True)
    @patch("plugins._skills.api.skills.os.makedirs")
    @patch("plugins._skills.api.skills.os.path.isdir", return_value=True)
    @patch("plugins._skills.api.skills.files")
