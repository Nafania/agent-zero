...
class TestRFC:
    ...
    async def test_process_delegates_to_runtime_handle_rfc(self):
        ...
        with patch("api.rfc.runtime.handle_rfc", new_callable=AsyncMock, return_value=mock_result):
    ...
    async def test_process_passes_input_to_handle_rfc(self):
        ...
        with patch("api.rfc.runtime.handle_rfc", new_callable=AsyncMock) as mock_handle:
