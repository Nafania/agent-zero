...
- Agent Zero is available on GitHub [github.com/ghcr.io/nafania/agent-zero](https://github.com/ghcr.io/nafania/agent-zero).
- You can download the files using a browser and extract or run `git clone https://github.com/ghcr.io/nafania/agent-zero` in your desired directory.

> [!NOTE]
> In my case, I used `cd ~/Desktop` and `git clone https://github.com/ghcr.io/nafania/agent-zero`, so my project folder is `~/Desktop/agent-zero`.
...
1. Pull the docker image `ghcr.io/nafania/agent-zero` from Docker Hub and run it with a web port (`80`) mapped and SSH port (`22`) mapped.
